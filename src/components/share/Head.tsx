...
const WEBSITE_URL = "truyenhay.com"
...
export default function Head({
    title = 'Đọc Truyện Online - Website chính thức - TruyenHay',
    description = 'Website đọc truyện miễn phí!',
    ...
    return (
        <NextHead>
            ...
            <meta name="application-name" content="truyenhay" />
